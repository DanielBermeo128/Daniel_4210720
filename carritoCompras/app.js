...
function agregarProducto(){
    var pass = prompt("Actividad del admin\nAgregue su contraseña");
    // If de juguete para agregar la autenticacion
        if(pass) {
            var desc = prompt("Agregue una descripcion del producto:");
            var precio = prompt("Agregue el precio del producto:");
            precio = Number(precio);
            // Se demuestra como se autoidentifica la etiqueta es distinta a la variable 
